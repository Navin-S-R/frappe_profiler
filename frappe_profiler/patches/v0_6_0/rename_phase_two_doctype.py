...
def execute():
	...
	if new_exists:
		frappe.logger().warning(
			"frappe_profiler: skipping Phase-Two DocType rename — both "
	...
	try:
		...
		frappe.log_error(title="frappe_profiler patch: rename phase-two doctype")
		return
	...
	# Drop our own settings cache too — paranoid but cheap.
	try:
